                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            ...
                                            <div class="product-info">
                                                <h2 class="product-title"><a href="product-details.html">Premium Joyful</a>
                                                </h2>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            ...
                                            <div class="product-info">
                                                <h2 class="product-title"><a href="product-details.html">Pink Flower
                                                        Tree</a></h2>
                                                <div class="product-price">
                                                    <span>$18</span>
                                                    <del>$21</del>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('assets/landing_page/img') }}/product/6.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="badge-2">10%</li>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('assets/landing_page/img') }}/product/7.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="badge-1">Hot</li>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('assets/landing_page/img') }}/product/8.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="badge-2">10%</li>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            ...
                                            <div class="product-info">
                                                <h2 class="product-title"><a href="product-details.html">Premium
                                                        Joyful</a></h2>
                                                <div class="product-price">
                                                    <span>$16</span>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="ltn__product-item text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('assets/landing_page/img') }}/product/5.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="badge-1">Hot</li>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-brief">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae
                                                        asperiores sit odit nesciunt, aliquid, deleniti non et ut dolorem!
                                                    </p>
                                                </div>
                                                <div class="product-hover-action product-hover-action-2">
                                                    <ul>
